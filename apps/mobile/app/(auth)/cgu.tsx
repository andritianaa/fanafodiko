...
const articles = [
  ...
  },
  {
    ...
    content:
      "Fanafodiko est une application gratuite de suivi et de gestion des médicaments destinée aux patients et à leurs aidants. Elle permet de planifier des prises de médicaments, d'envoyer des rappels et de suivre l'historique des traitements au sein d'un foyer.",
  },
  {
    title: 'Article 3 – Accès et inscription',
    content:
      "L'accès à l'Application est entièrement gratuit. La création d'un compte requiert la fourniture d'informations exactes (prénom, nom, adresse email). L'utilisateur est seul responsable de la confidentialité de ses identifiants et de toute activité réalisée depuis son compte.",
  },
  {
  ...
  },
  {
    ...
    content:
      "L'éditeur s'efforce d'assurer la disponibilité et la fiabilité de l'Application mais ne peut garantir un fonctionnement sans interruption. L'éditeur ne saurait être tenu responsable de dommages directs ou indirects résultant d'une utilisation incorrecte de l'Application.",
  },
  {
