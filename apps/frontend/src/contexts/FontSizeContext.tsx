...
export const FONT_SIZE_OPTIONS: { value: FontSize; label: string; htmlPx: string; iconSize: number }[] = [
...
export const FontSizeProvider = ({ children }: { children: React.ReactNode }) => {
  ...
  const iconSize = FONT_SIZE_OPTIONS.find((o) => o.value === fontSize)?.iconSize ?? 20
