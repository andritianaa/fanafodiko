  ...
  .object({
    profileId: z
      ...
      .openapi({
        ...
        description: "ID associated profile",
      }),
    name: z
      .string()
      .openapi({ example: "Doliprane", description: "Medication name" }),
    dosage: z
      .string()
      .openapi({ example: "500mg", description: "Dosage instructions" }),
    frequency: FrequencySchema,
    startDate: z
      .string()
      .datetime()
      .openapi({ example: "2023-01-01T00:00:00Z", description: "Start date" }),
    endDate: z
      .string()
      .datetime()
      .nullable()
    ...
    utcOffsetMinutes: z
      ...
      .openapi({
        example: -180,
        description:
          "Browser timezone offset from getTimezoneOffset(),negative for UTC+ zones (e.g., -180 for UTC+3/Madagascar)",
      }),
  })
...
export const UpdateMedicationSchema = z
  .object({
    ...
    dosage: z
      .string()
      .optional()
      .openapi({ example: "1000mg", description: "Dosage instructions" }),
    ...
    utcOffsetMinutes: z
      .number()
      .optional()
      .openapi({ example: -180, description: "Browser timezone offset" }),
  })
  .openapi("UpdateMedication");

export const ToggleMedicationStatusSchema = z
  .object({
    isActive: z
      .boolean()
      .openapi({
...
export const MedicationListSchema = z
  .array(MedicationResponseSchema)
  .openapi("MedicationList");
